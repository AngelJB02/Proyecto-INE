...
// Visor de imágenes en /registros:
// - Agrega columna de acción "Ver imagen"
// - Modal responsivo con loader y manejo de errores
// - Resolución de URLs (absolutas/relativas) y pequeña caché en memoria
...
export const Registros = () => {
  ...
  // Resolver URL de imagen desde posibles campos y normalizar contra base configurada
  ...
  // Abrir modal; usa caché si ya cargó la misma imagen
  ...
  // Cerrar modal y devolver foco al disparador
  const cerrarModal = () => {
        ...
        >
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2 id="imagen-modal-title">Imagen del registro</h2>
